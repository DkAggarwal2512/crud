...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      <img src="nsti.jpg" alt="" width="30" height="24" class="d-inline-block align-text-top">
      NSTI STUDENT REGSTRATION FORM.....
    </a>
  </div>
</nav>
    <form method="post">
  ...
  <button type="submit" class="btn btn-success m-3" name="Ondelete">Delete</button>
...
<table class="table table-bordered border-success" width="95%">
    <th>reg_no</th>
    <th>trainee_name</th>
    <th>phone_no</th>
    <th>nsti</th>
...
$sql = "INSERT INTO student(reg_no, trainee_name, phone_no, nsti, reg_date)
...
$d_sql = "DELETE FROM student WHERE student.reg_no=$reg";
...
if(isset($_POST['Onedit'])){
  ...
  $nsti = $_POST['nsti'];
  $date = $_POST['date'];
$u_sql = "UPDATE `student` SET `trainee_name` = '$tname',
 `phone_no`= '$tmobile', `nsti` = '$nsti', reg_date = $date WHERE `student`.`reg_no` = $reg;";
